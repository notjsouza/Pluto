export const CONFIG = {
  OAUTH_HANDLER_URL: process.env.NEXT_PUBLIC_OAUTH_HANDLER_URL || '',
  PLAID_HANDLER_URL: process.env.NEXT_PUBLIC_PLAID_HANDLER_URL || '',
  AI_HANDLER_URL: process.env.NEXT_PUBLIC_AI_HANDLER_URL || '',
